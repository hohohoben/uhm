...
library.theme = {
    ...
    bordercolor = Color3.fromRGB(20, 20, 145),
    accentcolor = Color3.fromRGB(28, 0, 139),
    accentcolor2 = Color3.fromRGB(16, 31, 78),
    outlinecolor = Color3.fromRGB(60, 76, 213),
    ...
    buttoncolor = Color3.fromRGB(255, 222, 255),
...
function library:CreateWatermark(name, position)
    ...
    watermark.Gradient.Color = ColorSequence.new({ ColorSequenceKeypoint.new(0.00, Color3.fromRGB(35, 35, 35)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(10, 10, 10)) })
